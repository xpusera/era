...
const ToServerCommandHandler toServerCommandTable[TOSERVER_NUM_MSG_TYPES] =
{
	...
	{ "TOSERVER_CAMERA_SPECTATOR_POS",     TOSERVER_STATE_INGAME, &Server::handleCommand_CameraSpectatorPos }, // 0x54
	{ "TOSERVER_PARTICLESPAWNER_COLLIDE",  TOSERVER_STATE_INGAME, &Server::handleCommand_ParticleSpawnerCollide }, // 0x55
};
...
const ClientCommandFactory clientCommandFactoryTable[TOCLIENT_NUM_MSG_TYPES] =
{
	...
	{ "TOCLIENT_MINIMAP_MODES",            0, true }, // 0x62
			...
			{ "TOCLIENT_SPAWN_PARTICLE_BATCH",     0, true }, // 0x64
				{ "TOCLIENT_CAMERA_CONTROL",          0, true }, // 0x65
				{ "TOCLIENT_SET_FOG",                 0, true }, // 0x66
				{ "TOCLIENT_SET_SKY_KEYFRAMES",       0, true }, // 0x67
		};
